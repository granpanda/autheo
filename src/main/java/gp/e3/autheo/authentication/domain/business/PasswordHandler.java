...
public class PasswordHandler {
	...
	InvalidKeySpecException, CheckedIllegalArgumentException {
	 ...
	 */
	public static String getSaltFromHashedAndSaltedPassword(String hashedAndSaltedPassword) throws CheckedIllegalArgumentException {
